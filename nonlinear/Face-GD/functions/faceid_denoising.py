...
def wo_proj_faceid_ddim_diffusion(x, seq, model, b, eta=0.5, rho_scale=1.0, idloss=None, stop=100, repeat=5, repeat_start=700, repeat_end=400):
...
def ae_faceid_ddim_diffusion(x, seq, model, b, eta=0.5, rho_scale=1.0, idloss=None, stop=100, repeat=5, repeat_start=700, repeat_end=400, ldm_start=500, ldm_end=300, ldm_model=None):
    # setup iteration variables
    n = x.size(0)
    seq_next = [-1] + list(seq[:-1])
    x0_preds = []
...
def z_faceid_ddim_diffusion(x, seq, model, b, eta=0.5, rho_scale=1.0, idloss=None, stop=100, repeat=5, repeat_start=700, repeat_end=400, ldm_start=500, ldm_end=300, ldm_model=None):
    # setup iteration variables
    n = x.size(0)
    seq_next = [-1] + list(seq[:-1])
    x0_preds = []
